...
public class AutomatonMain {
	/*
	 * Emilie : j'ai mis en commentaire le deuxieme automate car mes tests portent
	 * sur un seul automate
	 */

	/*
	 * automate testé ici : *(init) |true ? Move() :(droite) *(droite) |true and
	...
	public static void main(String[] args) {
		...
		/*
		 * Création de la liste de Funcalls pour chaque action autrement dit pour chaque
		 * transition
		 */
		...
		/*
		 * création de toutes les funCalls qui vont être utilisés dans l'automate pour
		 * le moment on utilise que 4 funcalls : Move, Egg, Pop et Protect
		 * 
		...
		/*
		 * création de toutes les actions formées avec les listes de funcalls pour le
		 * moment on utilise que 4 funcalls : Move, Egg, Protect et Pop
		 */
		...
		/*
		 * Création des transitions en fonction des condition, action et state qu'il
		 * doit recevoir
		 */
		...
		/*
		 * implémentation des listes de trnasitions en fonction des transitions qu'ils
		 * sont censé recevoir
		 */
		...
		/*
		 * pour le test on doit donner un state initial a Entity je le fais ici pour ce
		 * test mais plus tard il faudra gérer ca dans Entity directement
		 */
