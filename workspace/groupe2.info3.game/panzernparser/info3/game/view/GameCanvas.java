 ...
 * added so that it is aware of when the corresponding window is 
 * opened or closed.
 * 
 ...
 * 
 * NOTA BENE: this is not a class that you are supposed to change.
...
public class GameCanvas extends Canvas {
  ...
  public GameCanvas(GameCanvasListener l) {
     ...
     * off the drawing of the Canvas background before
     * the update/repaint methods are called, causing 
  ...
  /**
   * Gives the current width of the canvas, in pixels.
   * The horizontal X-axis grows from left to right.
   */
  public int getWidth() {
    return m_width;
  }
  ...
  /**
   * Gives the current height of the canvas, in pixels.
   * The vertical Y-axis grows downward.
   */
  ...
  /** 
   * Play the given audio stream for the specified duration.
   * A duration of -1 requests to play the audio stream up 
   * to the end. 
   * The end of play of an audio stream is always notified
   * to the canvas listener.
   * @param the name must be unique. if the name is already
   *        playing, the playing is stopped and restarted.
   */
  ...
  /*================================================================
   * None of the methods below are to be called by your game.
   * None of the fields are of interest.
   *================================================================*/
   ...
   * Our defined events will be handled here.
   */
