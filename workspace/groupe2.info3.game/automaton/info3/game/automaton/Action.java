...
public class Action {
	...
	/*
	 * Exemple de roue de la fortune : 25% Move / 10% Egg / Protect / 15% Wizz Donne
	 * : [25,35,85,100] 25% Move / 10% Egg Donne : [25,35] Comment la lire : Soit x
	 * un entier entre 1 et 100 Soit i = 0 Si i > taille du tab -> on n'a tiré
	 * personne Si x > ième case -> i++ et on recommence Sinon On a tiré la ième
	 * func
	 */
